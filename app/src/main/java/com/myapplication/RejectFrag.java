...
public class RejectFrag extends Fragment implements  recyclerContact.OnMoreInfoClickListener {
    recyclerContact adapter;
    ArrayList<MarkerDetails> list1;
...
// rettrive the data from database
        ...
        adapter = new recyclerContact(getActivity(),list1,this);
...
//////////////////////adding the data from database to list
    ...
    public void onMoreInfoClicked(int position) {
        ...
        MarkerDetails item = list1.get(position);
        showDialog(item);
    }
